...
begin
  ...
  where u.username = p_admin_username and u.password_hash = extensions.crypt(p_admin_password, u.password_hash) and u.position = 'Superuser';
...
insert into public.app_users (username, password_hash, name, position, email, must_change_password)
values ('kevjacob', extensions.crypt('Brother87@', extensions.gen_salt('bf')), 'Kelvin Sim', 'Superuser', 'kelvin@taisay.my', false)
